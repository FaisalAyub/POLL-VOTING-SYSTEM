...
{
    public abstract class PollAppWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static PollAppWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(PollAppWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<PollAppDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<PollAppDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<PollAppDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<PollAppDbContext, Task<T>> func)
        {
            T result;
